...
const std::array<std::string, uint32_t(UISpriteRenderDataComp::Offset::kNum)> UISpriteRenderDataComp::kOffsetEnumString_ = {
    "kMiddle",
    "kUp",
    "kUnder",
    "kLeft",
...
const std::array<Mat4x4, uint32_t(UISpriteRenderDataComp::Offset::kNum)> UISpriteRenderDataComp::kOffsetMatrix = {
...
void UISpriteRenderDataComp::Init() {
...
void UISpriteRenderDataComp::FirstUpdate() {
#ifdef _DEBUG
...
void UISpriteRenderDataComp::Debug([[maybe_unused]]const std::string& guiName)
{
#ifdef _DEBUG
...
const Mat4x4& UISpriteRenderDataComp::GetOffsetMatrix() const
{
    return offsetTransform_;
}

const Mat4x4& UISpriteRenderDataComp::GetUserOffsetMatrix() const
{
    return userOffsetTransformMatrix_;
}

void UISpriteRenderDataComp::Save(nlohmann::json& json)
{
    SaveCompName(json);
...
void UISpriteRenderDataComp::Load(nlohmann::json& json)
{
...
void UISpriteRenderDataComp::Load()
{
    Lamb::SafePtr textureManager = TextureManager::GetInstance();
    textureManager->LoadTexture(fileName);
    texHandle = textureManager->GetHandle(fileName);
